...
const Header = () => {
    return (
        <div className='md:flex justify-between items-center  md:px-20 py-4 shadow-lg'>
            <NavLink to='/'><h1 className='text-3xl font-semibold text-blue-400'>Quizzes</h1></NavLink>
